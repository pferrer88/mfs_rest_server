...
class DriversControllerTest < ActionController::TestCase
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post :create, driver: { code: @driver.code, name: @driver.name, username: @driver.username }
    end
  ...
  test "should update driver" do
    put :update, id: @driver, driver: { code: @driver.code, name: @driver.name, username: @driver.username }
    assert_redirected_to driver_path(assigns(:driver))
  end
