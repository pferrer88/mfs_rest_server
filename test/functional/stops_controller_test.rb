...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { completeDT: @stop.completeDT, isComplete: @stop.isComplete, sequence: @stop.sequence }
    end
  ...
  test "should update stop" do
    put :update, id: @stop, stop: { completeDT: @stop.completeDT, isComplete: @stop.isComplete, sequence: @stop.sequence }
    assert_redirected_to stop_path(assigns(:stop))
  end
